...
function GetInfo() {
    ...
    fetch('https://api.openweathermap.org/data/2.5/forecast?q=' + newName.value + '&appid=32ba0bfed592484379e51106cef3f204')
        ...
        .then(data => {
            ...
            for (i = 0; i < 5; i++) {
                document.getElementById("day" + (i + 1) + "Max").innerHTML = "Temp: " + Number(data.list[i].main.temp_max - 273.15).toFixed(2) + "&#8451;";
            }
...
function DefaultScreen() {
    document.getElementById("cityInput").defaultValue = "Canada";
    GetInfo();
}
